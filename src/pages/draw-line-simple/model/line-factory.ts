...
import type { StructPointForLine } from './draw-line-simple.types'
...
const addCurrentPoint = (
	...
	_e3 = addLineVertex(vertex, currentPoint, extrude, tx, 0)
	...
	_e3 = addLineVertex(vertex, currentPoint, extrude, tx, 1)
